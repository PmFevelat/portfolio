...
export const Products = () => {
  ...
  const testedProjects = [
    "Calice", "Peerz", "Skopa (Graph)", "Skopa (AI Agent)", "Shazam for need discovery V2", "Shazam for need discovery", "Syncrowd", "Reelay", "Kascad", "Presence V2", "Juntoo", "Ondanse", "Transition insurance for challenger software", "Waze / Glassdoor for Sales Intelligence", "Back again in the sales industry"
  ];
      ...
      <div className="grid grid-cols-1 gap-12 pt-10">
        {products.map((product: any, idx: number) => (
          <React.Fragment key={product.href}>
            {/* Afficher le sous-titre après le premier projet */}
            {idx === 1 && (
