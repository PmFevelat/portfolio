...
export const Products = () => {
  ...
  const testedProjects = ["Calice", "Peerz", "Skopa (Graph)", "Skopa (AI Agent)", "Shazam for need discovery V2", "Shazam for need discovery", "Syncrowd", "Reelay", "Kascad", "Presence V2", "Juntoo", "Ondanse"];
  
  // Projet avec le statut "delayed"
  const delayedProjects = ["Metricore"];
