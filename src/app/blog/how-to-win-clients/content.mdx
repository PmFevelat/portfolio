...
export const meta = {
  date: "2023-08-18",
  title: "My Unpopular Opinion About YC and the AI ecosystem",
  description:
    "YC is doubling down on AI agents, but without real counter-positioning, they're unlikely to thrive—incumbents own the data, the distribution, and increasingly, the interface.",
  image: "/images/agent.png",
  tags: ["YC", "AI"],
  href: "https://www.linkedin.com/pulse/my-unpopular-opinion-yc-ai-ecosystem-pierre-marie-fevelat-jrpae"
};
